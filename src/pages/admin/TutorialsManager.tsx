            ...
            <table className="w-full text-sm text-left">
              ...
              <tbody className="divide-y border-t">
                {isLoading ? (
                  ...
                  <tr><td colSpan={5} className="px-6 py-4 text-center">No tutorials found.</td></tr>
                ) : (
                  tutorials?.map(tutorial => (
                    <tr key={tutorial.id} className="hover:bg-muted/50 transition-colors">
                      <td className="px-6 py-4 font-medium">{tutorial.title}</td>
                      <td className="px-6 py-4 text-muted-foreground">{tutorial.subjects?.name}</td>
                      <td className="px-6 py-4">{tutorial.difficulty || '-'}</td>
