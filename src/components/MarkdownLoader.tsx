...
const MathLoading = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4">
      <motion.div
        className="text-center max-w-md w-full px-4 sm:px-6"
      ...
      >
        <div className="relative w-40 h-40 sm:w-48 sm:h-48 mx-auto mb-6 sm:mb-8">
          ...
          >
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-primary/30 to-secondary/30 backdrop-blur-sm border-2 border-primary/40 flex items-center justify-center shadow-lg">
          ...
          {["∫", "∑", "π", "√", "∞", "Δ", "θ", "α"].map((symbol, index) => {
            ...
            const radius = window.innerWidth < 640 ? 60 : 72;
            return (
              <motion.div
                key={symbol}
                className="absolute w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-card border border-primary/30 shadow-md"
                ...
                style={{
                  ...
                  marginTop: window.innerWidth < 640 ? "-16px" : "-20px",
                }}
              >
                <motion.span
                  className="text-base sm:text-lg font-bold bg-gradient-to-br from-primary to-secondary bg-clip-text text-transparent"
                  animate={{ rotate: 360 }}
                  transition={{ duration: 10, repeat: Infinity, ease: "linear" }}
                >
                  {symbol}
        ...
        <div className="h-6 mb-4 sm:mb-6 overflow-hidden">
...
const MarkdownLoader = ({ filePath, title }: MarkdownLoaderProps) => {
  ...
  const navData = getChapterNavigation(currentRoute);
  const prev = navData?.prev;
  const next = navData?.next;
  ...
  const goToLibrary = () => {
    window.location.href = navigationConfig.libraryPath;
  };
      ...
      <div className="flex min-h-screen">
        ...
        >
          <div className="p-4 sm:p-6">
            ...
            {/* Cross-link to Tutorial */}
            {tutorialPath && (
              <div className="border-t border-gray-200 dark:border-gray-800 pt-4 mb-4">
                <button
                  onClick={goToTutorial}
                  className="w-full flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white rounded-lg font-medium transition-all transform hover:scale-105 shadow-md"
                >
            ...
            <div className="border-t border-gray-200 dark:border-gray-800 pt-4">
              <div className="space-y-2">
                {prev && (
                  <button
                    onClick={() => window.location.href = prev.notesPath}
                ...
                {next && (
                  <button
                    onClick={() => window.location.href = next.notesPath}
                  ...
                  {tutorialPath && (
                    <div className="border-t border-gray-200 dark:border-gray-800 pt-4 mb-4">
                      <button
                        ...
                        className="w-full flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white rounded-lg font-medium transition-all shadow-md"
                      >
                        <GraduationCap className="w-5 h-5" />
                        View Tutorial
                      </button>
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 pt-4">
                    <div className="space-y-2">
                      {prev && (
                        <button
                          onClick={() => {
                            window.location.href = prev.notesPath;
                            setMobileSidebarOpen(false);
                          }}
                          className="flex items-center gap-2 w-full px-3 py-2 text-sm font-serif text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all rounded-md hover:bg-gray-100 dark:hover:bg-gray-800"
                        >
                      ...
                      {next && (
                        <button
                          onClick={() => {
                            window.location.href = next.notesPath;
                            setMobileSidebarOpen(false);
                          }}
